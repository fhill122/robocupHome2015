...
if("TRUE" STREQUAL "TRUE")
  set(manipulation_SOURCE_PREFIX /home/robocuphome/robocuphome2015/src/manipulation)
  set(manipulation_DEVEL_PREFIX /home/robocuphome/robocuphome2015/devel)
  ...
  set(manipulation_INSTALL_PREFIX /home/robocuphome/robocuphome2015/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'manipulation' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ivan <ivan@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'manipulation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robocuphome/robocuphome2015/src/manipulation/${idir}'.  Ask the maintainer 'ivan <ivan@todo.todo>' to fix it.")
    endif()
