...
def main():
    ...
    right_pose = []
    position = []
    tray_length = (36.4 + 11.0)/100
    
    for i in range(20):
        right_pose.append([0.6+i*0.005, -tray_length/2, 0.3, -0.7071, 0.0, 0.0, 0.7071])
        left_pose.append([0.6, tray_length/2, 0.3,0.7071, 0.0, 0.0, 0.7071])
